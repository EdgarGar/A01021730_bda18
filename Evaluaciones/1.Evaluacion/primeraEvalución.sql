...
--Consultas 
SELECT * from GOMITAS WHERE NAME='gomita1';

SELECT SUM(PRECIO)/COUNT(*) as AVG from GOMITAS WHERE NAME='gomita1';

SELECT MAX(PRECIO) as MAX from GOMITAS WHERE NAME='gomita1';

SELECT MIN(PRECIO) as MAX from GOMITAS WHERE NAME='gomita1';
